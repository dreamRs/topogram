...
if (HTMLWidgets.shinyMode) {
  ...
  // Update value used
  var values;
  Shiny.addCustomMessageHandler("update-topogram-value", function(params) {
    ...
    if (typeof carto != "undefined") {
      ...
      //console.log(values);
      carto.color(function(d) {
        var colorScale = d3
          .scaleSequential(d3[pal])
        ...
        if (typeof lgdTopo !== "undefined") {
          ...
          svg.select(".legendSequential").call(lgdTopo);
        }
  ...
  // Update vector used
  Shiny.addCustomMessageHandler("update-topogram-vector", function(params) {
    var carto = get_widget(params.id);
    if (typeof carto != "undefined") {
      var paramsTopo = get_params(params.id);
      var lgdTopo = get_legend(params.id);
  ...
  Shiny.addCustomMessageHandler("update-topogram-iteration", function(params) {
    var carto = get_widget(params.id);
    if (typeof carto !== "undefined") {
